var speakWorker;
try {
  speakWorker = new Worker('./framework/speak/speakWorker.js');
} catch(e) {
...
function speak(text, args) {
  ...
  if (args && args.noWorker) {
    ...
    var timeThisOut = words.length * 430;
    
	setTimeout(function(){clearInterval(interval)}, timeThisOut);
